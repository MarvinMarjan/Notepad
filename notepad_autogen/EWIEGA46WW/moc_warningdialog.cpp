...
#include <memory>
#include "../../../notepad/warningdialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WarningDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WarningDialog_t qt_meta_stringdata_WarningDialog = {
    {
        QT_MOC_LITERAL(0, 13),  // "WarningDialog"
        QT_MOC_LITERAL(14, 20),  // "on_ok_button_clicked"
        QT_MOC_LITERAL(35, 0)   // ""
    },
    "WarningDialog",
...
Q_CONSTINIT static const uint qt_meta_data_WarningDialog[] = {
...
Q_CONSTINIT const QMetaObject WarningDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_WarningDialog.offsetsAndSizes,
    qt_meta_data_WarningDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_WarningDialog_t,
        // Q_OBJECT / Q_GADGET
